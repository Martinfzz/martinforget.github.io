...
const Contact = () => {
  ...
  return (
    <>
      <div>
        <div className="mt-8 sm:px-3 bg-gray-100 py-20">
          ...
          <div className="md:grid md:grid-cols-6 md:gap-6 container mx-auto">
            ...
            <div className="mt-8 md:mt-8 md:col-start-4 md:col-end-7 xl:col-start-4 xl:col-end-6">
                    ...
                    <div className="grid grid-cols-6 gap-6">
                      <div className="col-span-6 sm:col-span-6">
                        <input
                          ...
                          autoComplete="name"
                          placeholder="Name"
                          className="mt-1 focus:ring-yellow-700 focus:border-yellow-700 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"
                        />
                      </div>
                      ...
                      <div className="col-span-6 sm:col-span-6">
                        <textarea
                          ...
                          name="message"
                          rows={3}
                          className="shadow-sm focus:ring-yellow-700 focus:border-yellow-700 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"
